...
[onedata/luma](https://github.com/onedata/luma/tree/release/18.02.0-rc12) GitHub repository.
...
$ docker run -v $PWD/db.json:/luma/db.json -p 8080:8080 -it onedata/luma:18.02.0-rc12
```
...
$ cd luma
$ git checkout release/18.02.0-rc12
$ cd luma
...
```bash
[Onedata REST CLI - 18.02.0-rc12]$ export ONEPANEL_HOST=https://<ONEPROVIDER_IP>:9443
[Onedata REST CLI - 18.02.0-rc12]$ export ONEPANEL_BASIC_AUTH=admin:<ADMIN_PASSWORD>
# First get the list of storage ids attached to this Oneprovider
[Onedata REST CLI - 18.02.0-rc12]$ onepanel-rest-cli getStorages | jq .
{
  "ids": [
...
[Onedata REST CLI - 18.02.0-rc12]$ onepanel-rest-cli getStorageDetails id=sF6AGzSiGVNSRGvxiA6p3287LUZS-nyMhDzKubrGsSM | jq .
{
...
```bash
[Onedata REST CLI - 18.02.0-rc12]$ onezone-rest-cli getCurrentUser
{
...
[Onedata REST CLI - 18.02.0-rc12]$ onezone-rest-cli getUserGroups | jq .
{
  "groups": [
...
[Onedata REST CLI - 18.02.0-rc12]$ onezone-rest-cli getUserGroup gid=zWB2Jf3ivo0Zhevl9kexOvk9OaDAsTBAwtpQnEzuFu8 | jq .
{
  "type": "role",
  "name": "GroupA",
