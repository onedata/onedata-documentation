...
|---|---|---|---|---|
|**Body**|**serviceHosts**  <br>*required*|The hosts specification where the workers should be deployed.|[ServiceHosts](../definitions/ServiceHosts.md#servicehosts)|--|
