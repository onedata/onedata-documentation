...
|**privileges**  <br>*required*||< enum (handle_service_delete, handle_service_list_handles, handle_service_update, handle_service_register_handle, handle_service_view) > array|
