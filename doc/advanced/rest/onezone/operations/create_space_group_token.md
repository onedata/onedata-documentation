...
<a name="create_space_group_token"></a>
#### Create space invite token for group
```
POST /spaces/{id}/groups/token
```
...
|**Body**|**privileges**  <br>*optional*|Optional privileges for group in space.|[SpacePrivileges](../definitions/SpacePrivileges.md#spaceprivileges)|--|
