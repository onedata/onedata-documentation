...
https://$HOST/api/v3/onezone/groups/HwUpk8jrwxKOe45uzLFX2GVC8lKEasj4q253sptVqF8/spaces/join
```
...
|---|---|---|
|**201**|URI of the joined space in form https://onezone.domain/api/onezone/v3/groups/{id}/spaces/{sid} is returned in the response `Location` header.  <br>**Headers** :   <br>`Location` (string) : URI of the joined space.|No Content|
