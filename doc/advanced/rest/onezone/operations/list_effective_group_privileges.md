...
<a name="list_effective_group_privileges"></a>
#### List group's effective privileges
```
GET /groups/{id}/effective_privileges
```


##### Description
Returns the list of group effective privileges for Onezone.
...
https://$HOST/api/v3/onezone/groups/T5x_HhFYOnILOCUf9OqgExw00RwaU2MXT5122oWk_sM/effective_privileges
...
|---|---|---|
|**200**|The list of group effective privileges in Onezone.|[OnezonePrivileges](../definitions/OnezonePrivileges.md#onezoneprivileges)|
...
```
json :
"/groups/string/effective_privileges"
```
