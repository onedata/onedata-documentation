...
*Onezone* is responsible for authentication and authorization of users, makes it possible for users from different zones to communicate with each other and share data. It allows providers from different zones to interact with each other i.e. allowing users from different zones to support their spaces regardless of the zone in which provider is located.

<p align="center">
<img src="../img/Onezone101.svg" width="580">
</p>

As *onedata.org* is a main public zone, any provider registered there allow the users to access their data through *onedata.org*.
...
A user can use several providers simultaneously to manage their data. Onedata exposes combined storage space of all providers to the user and ensures access to user's data is instant and transparent.
