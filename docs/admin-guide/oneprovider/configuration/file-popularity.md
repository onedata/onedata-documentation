...
The mechanism for given space can be enabled in Oneprovider's Onepanel, in the 
`Spaces -> "Space Name" -> File popularity` tab, as presented below:

![*File popularity* configuration tab](../../../../images/admin-guide/oneprovider/configuration/file-popularity/file_popularity_config.png)
...
value of [*popularity function*](#the-popularity-function) equal to file that was 
