...
It is possible to choose the type of [feed][3] for populating the DB. In the case of
...
This table can be populated automatically only with entries that associate the storage
