...
For more information about ports setup, see [Firewal setup][1].
...
3. Nagios
   ...
   To monitor the service status, you can utilize our [Nagios scripts][2]
...
1. `crash.log`
   ...
   For more information, refer to the [official documentation][4].
...
[1]: configuration/network-and-firewall.md

[2]: https://github.com/onedata/nagios-plugins-onedata

[3]: configuration/advanced-config.md

[4]: https://www.erlang.org/doc/apps/erts/crash_dump.html

[5]: https://www.erlang.org/doc/man/run_erl.html
