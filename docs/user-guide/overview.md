...
Access to resources in Onedata is based on user [memberships][Groups and Memberships]. These memberships 
define the set of resources available to a user and which operations are permitted. 
The graphical user interface (GUI) reflects these rules by 
showing only the resources available to a given user, as described in the 
sections below.
...
| Tab                         | Description                                                                                                                |
|-----------------------------|----------------------------------------------------------------------------------------------------------------------------|
| [Tokens][Tokens]            | Create and manage tokens used for authorization.                                                                           |
| [Discovery][Data discovery] | Explore metadata indexing and perform advanced searches across files.                                                      |
