...
![Switch supporting provider view](../../images/user-guide/web-file-browser/switch-provider.png#bordered)
...
> *NOTE:* 
> Navigation slightly differs on mobile devices and on desktop browsers. In this section we describe a desktop mode. See [#mobile-file-browser] for mobile mode guide.
